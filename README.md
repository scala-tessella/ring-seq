# **RingSeq**
[![ring-seq Scala version support](https://index.scala-lang.org/scala-tessella/ring-seq/ring-seq/latest-by-scala-version.svg?platform=jvm)](https://index.scala-lang.org/scala-tessella/ring-seq/ring-seq)
...
```scala
libraryDependencies += "io.github.scala-tessella" %% "ring-seq" % "0.2.0"
```
