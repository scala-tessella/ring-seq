...
Adds implicit methods to Scala 2 both immutable and mutable [`Seq`](https://www.scala-lang.org/api/current/scala/collection/Seq.html) (and subtypes) for when a sequence needs to be considered **circular**, its elements forming a ring.
