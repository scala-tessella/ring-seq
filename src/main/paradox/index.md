...
but the underlying design has (at least for me) a very steep learning curve and the community help is weak. One clear maintenance advantage is that the source code is the same for Scala 2.13 and Scala 3.
